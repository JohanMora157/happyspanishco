      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            <Link href="#home" className="flex items-center gap-2 mb-4 group w-fit">
              <Image
            ...
            <p className="text-white/70 max-w-md">
              A different Spanish school in Cali, Colombia. Personalized Spanish lessons, online or in person, with cultural experiences and friendly native teachers.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70">
              ...
              <li>
                <Link
                  href="mailto:Happyspanishco@gmail.com"
                  className="hover:text-primary transition-colors"
                >
                  Happyspanishco@gmail.com
                </Link>
              </li>
              <li>
                <Link
              ...
              <li>San Antonio, Cali, Colombia</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 pt-8 text-center">
          <p className="text-white/60 text-sm mb-2">
            © 2026 Happy Spanish. All rights reserved.
          </p>
          <p className="text-white/40 text-xs">
            Website demo by Global Automate.
          </p>
        </div>
      </div>
    </footer>
